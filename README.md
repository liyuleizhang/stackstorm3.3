# StackStorm3.3 Docker Compose 部署方法

## Docker-compose部署StackStorm，测试StackStorm使用，不建议生产使用，Python3版本。
...
用户名：st2admin
密码：Ch@ngeMe
![Image text](https://raw.githubusercontent.com/liyuleizhang/img/main/st2-docker-compose/WX20210407-105318.png)
...
```
![Image text](https://raw.githubusercontent.com/liyuleizhang/img/main/st2-docker-compose/WX20210407-120606.png)
注意如果报错，先确定pack包内pack.yaml文件的python版本是否是3
![Image text](https://raw.githubusercontent.com/liyuleizhang/img/main/st2-docker-compose/WX20210407-120929.png)
安装完成后，pack文件保存在st2client容器的/opt/stackstorm/packs目录中
![Image text](https://raw.githubusercontent.com/liyuleizhang/img/main/st2-docker-compose/WX20210407-121327.png)
官方pack地址
```shell
https://exchange.stackstorm.org/
```
安装官方添加pack命令（注意修改要安装的pack名）
```shell
docker-compose exec st2client st2 pack install ansible
```
![Image text](https://raw.githubusercontent.com/liyuleizhang/img/main/st2-docker-compose/WX20210407-114534.png)

### 卸载pack
卸载已安装pack
```shell
docker-compose exec st2client st2 pack remove sensu hello_st2
```
![Image text](https://raw.githubusercontent.com/liyuleizhang/img/main/st2-docker-compose/WX20210407-144236.png)

也可操作build-stackstorm-image文件夹内说明在构建镜像时提前放置好pack
